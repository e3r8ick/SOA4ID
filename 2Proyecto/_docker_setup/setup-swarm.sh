...
function createManagerNode {
  ...
  do
    ...
    docker-machine create -d virtualbox --virtualbox-disk-size ${DISK_SIZE} --virtualbox-memory ${MEMORY} manager$i
  done
}
...
function createWorkerNode {
  ...
  do
    ...
    docker-machine create -d virtualbox --virtualbox-disk-size ${DISK_SIZE} --virtualbox-memory ${MEMORY} worker$i
  done
}
